 ...
 *
 * const process_move = async (coord: number) => { ...siehe unten... }
 *
...
const process_move = (coord: number) => {
...
export class TaskQueue<T> {
	...
	constructor(private execute_task: (task: T) => Promise<void>) {}
	...
	private async process_next(): Promise<void> {
