...
Eine natürliche Zahl heißt _Palindromzahl_, wenn sie im Dezimalsystem von vorne wie von hinten gleich gelesen werden kann, wie z.B. `10101` und `9229`, aber nicht `123`.

Implementiere eine Funktion `next_palindrome(n)`, die für eine natürliche Zahl n die kleinste Palindromzahl bestimmt, die größer oder gleich n ist.
