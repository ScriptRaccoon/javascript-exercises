...
Genauer gesagt, implementiere eine Funktion `repeat_with_delay(fn, delay, repetitions)`, die eine Funktion, eine Verzögerung (in Millisekunden), sowie eine Anzahl von Wiederholungen erwartet. Führt man diese aus, wird die ursprüngliche Funktion entsprechend oft ausgeführt, aber dazwischen wird immer gewartet.
